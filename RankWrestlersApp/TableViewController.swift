...
class TableViewController: UIViewController, MatchesModelDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableViewController.estimatedRowHeight = UITableView.automaticDimension
